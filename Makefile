...
test_single_reg_mov: $(TARGET)
	@echo
	$(call run_test_disasm,./asm/disasm/listing_0037_single_register_mov.asm)

test_many_reg_mov: $(TARGET)
	$(call run_test_disasm,./asm/disasm/listing_0038_many_register_mov.asm)

test_imm_to_reg_mov: $(TARGET)
	$(call run_test_disasm,./asm/disasm/imm_to_reg_movs.asm)

test_mem_to_reg_mov_no_disp_no_direct: $(TARGET)
	$(call run_test_disasm,./asm/disasm/mem_to_reg_mov_no_disp_no_direct.asm)

test_mem_to_reg_mov_8bit_disp: $(TARGET)
	$(call run_test_disasm,./asm/disasm/mem_to_reg_mov_8bit_disp.asm)

test_mem_to_reg_mov_16bit_disp: $(TARGET)
	$(call run_test_disasm,./asm/disasm/mem_to_reg_mov_16bit_disp.asm)

test_address_as_destination: $(TARGET)
	$(call run_test_disasm,./asm/disasm/address_as_destination.asm)

test_listing_39: $(TARGET)
	$(call run_test_disasm,./asm/disasm/listing_0039_more_movs.asm)

test_direct_address_mov: $(TARGET)
	$(call run_test_disasm,./asm/disasm/direct_address_mov.asm)

test_imm_to_rm_mov: $(TARGET)
	$(call run_test_disasm,./asm/disasm/imm_to_rm_mov.asm)

test_mem_to_accumulator_mov: $(TARGET)
	$(call run_test_disasm,./asm/disasm/mem_to_accumulator_mov.asm)

test_accumulator_to_mem_mov: $(TARGET)
	$(call run_test_disasm,./asm/disasm/accumulator_to_mem_mov.asm)

test_listing_40: $(TARGET)
	$(call run_test_disasm,./asm/disasm/listing_0040_challenge_movs.asm)

test_add_sub_cmp_rm_reg: $(TARGET)
	$(call run_test_disasm,./asm/disasm/add_sub_cmp_rm_reg.asm)

test_add_sub_cmp_imm_rm: $(TARGET)
	$(call run_test_disasm,./asm/disasm/add_sub_cmp_imm_rm.asm)

test_non_wide_accumulator_to_mem_mov_and_vice_verca: $(TARGET)
	$(call run_test_disasm,./asm/disasm/non_wide_accumulator_to_mem_mov_and_vice_verca.asm)

test_add_sub_cmp_imm_accumulator: $(TARGET)
	$(call run_test_disasm,./asm/disasm/add_sub_cmp_imm_accumulator.asm)

test_jnz: $(TARGET)
	$(call run_test_disasm,./asm/disasm/jnz.asm)

test_all_conditional_jumps: $(TARGET)
	$(call run_test_disasm,./asm/disasm/all_conditional_jumps.asm)

test_all_loops: $(TARGET)
	$(call run_test_disasm,./asm/disasm/all_loops.asm)

test_listing_41: $(TARGET)
	$(call run_test_disasm,./asm/disasm/listing_0041_add_sub_cmp_jnz.asm)

test_rm_to_sr_mov: $(TARGET)
	$(call run_test_disasm,./asm/disasm/rm_to_sr_mov.asm)

test_sr_to_rm_mov: $(TARGET)
	$(call run_test_disasm,./asm/disasm/sr_to_rm_mov.asm)

newline:
	@echo

test_sim_imm_to_reg_w_movs: $(TARGET)
	$(call run_test_sim,./asm/sim/listing_0043_immediate_movs.asm)
...
test_sim_reg_to_reg_w_mov: $(TARGET)
	$(call run_test_sim,./asm/sim/listing_0044_register_movs.asm)
...
test_sim_reg_to_sr_mov: $(TARGET)
	$(call run_test_sim,./asm/sim/reg_to_sr_mov.asm)
...
test_sim_sr_to_reg_mov: $(TARGET)
	$(call run_test_sim,./asm/sim/sr_to_reg_mov.asm)
...
test_sim_listing_45: $(TARGET)
	$(call run_test_sim,./asm/sim/listing_0045_challenge_register_movs.asm)
...
test_sim_listing_46: $(TARGET)
	$(call run_test_sim,./asm/sim/listing_0046_add_sub_cmp.asm)
...
test_sim_listing_0048_ip_register: $(TARGET)
	$(call run_test_sim,./asm/sim/listing_0048_ip_register.asm)
	@grep -q ";.*ax: 0" $(OUTPUT_ASM)
...
test_sim_listing_0049_conditional_jumps: $(TARGET)
	@$(call run_test_sim,./asm/sim/listing_0049_conditional_jumps.asm)
...
test_sim_listing_0050_challenge_jumps: $(TARGET)
	@$(call run_test_sim,./asm/sim/listing_0050_challenge_jumps.asm)
...
test_sim_all_conditional_jumps_and_loops: $(TARGET)
	@$(call run_test_sim,./asm/sim/all_conditional_jumps_and_loops.asm)
...
test_sim_listing_0051_memory_mov: $(TARGET)
	@$(call run_test_sim,./asm/sim/listing_0051_memory_mov.asm)
...
test_sim_listing_0052_memory_add_loop: $(TARGET)
	@$(call run_test_sim,./asm/sim/listing_0052_memory_add_loop.asm)
...
test_sim_listing_0053_add_loop_challenge: $(TARGET)
	@$(call run_test_sim,./asm/sim/listing_0053_add_loop_challenge.asm)
	@grep -q ";.*bx: 6" $(OUTPUT_ASM)
	@grep -q ";.*dx: 6" $(OUTPUT_ASM)
